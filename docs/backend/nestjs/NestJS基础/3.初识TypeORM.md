...
![image-20230912193539492](https://cdn.jsdelivr.net/gh/zhu325/markdown-img/blog/image-20230912193539492.png)

#### 数据库相关工具

- ERD设计：Navicat、 dbdesigner、QuicKDBD等在线工具
- 数据库设计参考 :[open.yesapi.cn/list.html ](open.yesapi.cn/list.html )

####   常见数据库

![image-20230912193828393](https://cdn.jsdelivr.net/gh/zhu325/markdown-img/blog/image-20230912193828393.png)

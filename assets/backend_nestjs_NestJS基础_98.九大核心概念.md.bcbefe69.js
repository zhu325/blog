...
<span class="line"><span style="color:#24292e;">  ],</span></span>
<span class="line"><span style="color:#24292e;">})</span></span>
<span class="line"><span style="color:#24292e;">export class AppModule {}</span></span></code></pre></div><h4 id="useexisting" tabindex="-1">useExisting <a class="header-anchor" href="#useexisting" aria-label="Permalink to &quot;useExisting&quot;">​</a></h4><p>这其实只是一个别名的使用，相当于给同一个provider多个token，如下，当我们注入的时候@Inject(&#39;AliasedLoggerService&#39;)和@Inject(LoggerService)，最终使用的是同一个LoggerService的实例</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">@Injectable()</span></span>
...
<span class="line"><span style="color:#24292e;">})</span></span>
<span class="line"><span style="color:#24292e;">export class AppModule {}</span></span></code></pre></div><p>想了解更多关于自定义provider的知识，请移步官网：<a href="https://docs.nestjs.com/fundamentals/custom-providers" target="_blank" rel="noreferrer">https://docs.nestjs.com/fundamentals/custom-providers</a></p><h3 id="_3-跨模块共享服务" tabindex="-1">3. 跨模块共享服务 <a class="header-anchor" href="#_3-跨模块共享服务" aria-label="Permalink to &quot;3. 跨模块共享服务&quot;">​</a></h3><p>provider具有自己的作用域，默认只在声明provider的模块内起效。如果要跨模块进行共享，前提是该服务要在在module中进行导出，也就是exports操作，exports可以填入完整的provider，也可以只填它的token(token后面会说)</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">@Module({</span></span>
...
<span class="line"><span style="color:#24292e;">})</span></span>
<span class="line"><span style="color:#24292e;">export class UserModule {}</span></span></code></pre></div><p>其它模块想使用的话可以直接在module的imports中添加该模块或者在providers中添加该服务</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">@Module({</span></span>
...
<span class="line"><span style="color:#24292e;">  providers: [UserService],</span></span>
<span class="line"><span style="color:#24292e;">})</span></span>
<span class="line"><span style="color:#24292e;">export class UserModule {}</span></span></code></pre></div><p>或者也可以使用全局模块，为Module增加@Global()装饰器，比如我的数据库Orm的Module就作为了全局模块</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">import { Global, Module } from &#39;@nestjs/common&#39;;</span></span>
...
<span class="line"><span style="color:#24292e;">})</span></span>
<span class="line"><span style="color:#24292e;">export class PrismaModule {}</span></span></code></pre></div><p>当然，咱们所有的模块都需要在根模块AppModule中的imports引入进去</p><h3 id="_4-可选的provider" tabindex="-1">4.可选的provider <a class="header-anchor" href="#_4-可选的provider" aria-label="Permalink to &quot;4.可选的provider&quot;">​</a></h3><p>有些时候可能不需要实例化一个服务类，可能需要根据配置文件灵活处理，这时候可以给对应的注入服务再增加一个@Optional()装饰器就行</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">constructor(@Optional() @Inject(&#39;service&#39;) private service: xxxService) {}</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">constructor(@Optional() @Inject(&#39;service&#39;) private service: xxxService) {}</span></span></code></pre></div><h3 id="_5-通过属性注入" tabindex="-1">5. 通过属性注入 <a class="header-anchor" href="#_5-通过属性注入" aria-label="Permalink to &quot;5. 通过属性注入&quot;">​</a></h3><p>这种注入方式用的极少，一种情况是你的顶级服务类class依赖了一个或多个providers，它的后代class将一直通过super()的方式进行构造，想想也还是比较可怕的。这时可以使用属性构造的方法：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">import { Injectable, Inject } from &#39;@nestjs/common&#39;;</span></span>
<span class="line"><span style="color:#e1e4e8;"></span></span>
...
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><p>如果你的服务类没有继承自别的类，那请继续使用constructor构造函数来注入</p><h2 id="三、modules" tabindex="-1">三、Modules <a class="header-anchor" href="#三、modules" aria-label="Permalink to &quot;三、Modules&quot;">​</a></h2><p>A module is a class annotated with a @Module() decorator. The @Module() decorator provides metadata that <strong>Nest</strong> makes use of to organize the application structure.</p><p>可以看出，nestjs也是模块化编程的思想，一个应用由一个个拆分的模块来组成，每个模块负责自己的一部分业务，一个应用至少有一个模块，也就是根模块，使用@Module()装饰器来声明一个模块，模块也是一个类。</p><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/5ccda297aaf148a2818955d21233ff4c~tplv-k3u1fbpfcp-zoom-1.image" alt=""></p><h3 id="_1-module-装饰器" tabindex="-1">1. @Module()装饰器 <a class="header-anchor" href="#_1-module-装饰器" aria-label="Permalink to &quot;1. @Module()装饰器&quot;">​</a></h3><p>需要一个参数，是一个对象，里面包含四个属性，用来描述这个module，上面其实已经都讲到了</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">@Module({</span></span>
...
<span class="line"><span style="color:#24292e;">})</span></span>
<span class="line"><span style="color:#24292e;">export class CommonModule {}</span></span></code></pre></div><h3 id="_4-模块类中也可以注入service" tabindex="-1">4. 模块类中也可以注入Service <a class="header-anchor" href="#_4-模块类中也可以注入service" aria-label="Permalink to &quot;4. 模块类中也可以注入Service&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">import { Module } from &#39;@nestjs/common&#39;;</span></span>
...
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><h3 id="_5-全局模块global-modules" tabindex="-1">5. 全局模块Global modules <a class="header-anchor" href="#_5-全局模块global-modules" aria-label="Permalink to &quot;5. 全局模块Global modules&quot;">​</a></h3><p>通过@Global()装饰器声明一个全局模块，只需要在根模块imports注册该全局模块，就可以在其他所有模块内使用它导出的Service</p><h3 id="_6-动态模块dynamic-modules" tabindex="-1">6. 动态模块Dynamic modules <a class="header-anchor" href="#_6-动态模块dynamic-modules" aria-label="Permalink to &quot;6. 动态模块Dynamic modules&quot;">​</a></h3><p>这是nest提供的一个强大功能，可以让我们对模块进行定制化操作，自定义模块的注册，动态提供providers，看一下官方的示例</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">import { Module, DynamicModule } from &#39;@nestjs/common&#39;;</span></span>
...
<span class="line"><span style="color:#24292e;">    };</span></span>
<span class="line"><span style="color:#24292e;">  }</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><p>原理其实很简单，就是给当前Module类提供一个forRoot方法，该方法返回一个新的Module，这个Module的类型是一个DynamicModule，在其他模块需要注册使用时，可以使用DatabaseModule.forRoot(参数)来动态的注册不同的Module，以达到提供不同providers的目的。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">@Module({</span></span>
...
<span class="line"><span style="color:#24292e;">})</span></span>
<span class="line"><span style="color:#24292e;">export class AppModule {}</span></span></code></pre></div><p><strong>如果想在全局作用域内注册一个动态Module，则在forRoot方法的返回值对象中加入global:true这个属性，当然一般情况下，nestjs其实不提倡搞全局模块的，我们按需使用就行。</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">{</span></span>
...
<span class="line"><span style="color:#24292e;">  providers: providers,</span></span>
<span class="line"><span style="color:#24292e;">  exports: providers,</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><p><strong>动态模块的重导出可以省略forRoot()方法，如</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">@Module({</span></span>
<span class="line"><span style="color:#e1e4e8;">  imports: [DatabaseModule.forRoot([User])],</span></span>
...
<span class="line"><span style="color:#24292e;">  }</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><h3 id="_2-应用类中间件" tabindex="-1">2. 应用类中间件 <a class="header-anchor" href="#_2-应用类中间件" aria-label="Permalink to &quot;2. 应用类中间件&quot;">​</a></h3><p>我们知道@Module()装饰器内没有给middleware的配置，那么怎么办呢？这时候我们需要在module类中使用config进行加载，需要让module类实现NestModule接口，实现里面configure方法进行</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">@Module({</span></span>
...
<span class="line"><span style="color:#24292e;">  }</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><p>apply方法表名要加载的是哪个中间件，forRootes方法表名对哪个请求路径起作用，这个和app.use(路径, 中间件)如出一辙，这里还可以对forRoutes进行更详细的配置，传入一个对象针对特定的某一个请求，path可以使用正则匹配？、+、<em>、()等，使用fastify驱动的需要注意不能使用</em>，如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">export class AppModule implements NestModule {</span></span>
...
<span class="line"><span style="color:#24292e;">  }</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><p><strong>注意，configure方法可以是异步的，如果里面有需要异步处理的操作，可以使用async/await来等待操作完成再往下进行</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">export class AppModule implements NestModule {</span></span>
...
<span class="line"><span style="color:#24292e;">  }</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><p>默认情况下Nestjs应用使用express驱动，会使用body-parser来解析response的数据，如果你想自定义的话，需要在NestFactory.create()时将bodyParser置为false</p><h4 id="middlewareconsumer" tabindex="-1">MiddlewareConsumer <a class="header-anchor" href="#middlewareconsumer" aria-label="Permalink to &quot;MiddlewareConsumer&quot;">​</a></h4><ul><li>实现链式调用</li><li>apply可以放置多个middleware</li><li>forRoutes可以使用单个string路径，多个string路径，RouteInfo对象，单个Controller，多个Controller</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">@Module({</span></span>
<span class="line"><span style="color:#e1e4e8;">  imports: [],</span></span>
<span class="line"><span style="color:#e1e4e8;">})</span></span>
<span class="line"><span style="color:#e1e4e8;">export class AppModule implements NestModule {</span></span>
<span class="line"><span style="color:#e1e4e8;">  configure(consumer: MiddlewareConsumer) {</span></span>
...
<span class="line"><span style="color:#24292e;">  }</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><ul><li>exclude可以排除不使用中间件的路径</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">consumer</span></span>
<span class="line"><span style="color:#e1e4e8;">  .apply(LoggerMiddleware)</span></span>
...
<span class="line"><span style="color:#24292e;">  )</span></span>
<span class="line"><span style="color:#24292e;">  .forRoutes(CatsController);</span></span></code></pre></div><h3 id="_3-函数式中间件" tabindex="-1">3. 函数式中间件 <a class="header-anchor" href="#_3-函数式中间件" aria-label="Permalink to &quot;3. 函数式中间件&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">import { Request, Response, NextFunction } from &#39;express&#39;;</span></span>
<span class="line"><span style="color:#e1e4e8;"></span></span>
...
<span class="line"><span style="color:#24292e;">  console.log(\`Request...\`);</span></span>
<span class="line"><span style="color:#24292e;">  next</span></span></code></pre></div><p>使用</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">consumer</span></span>
...
<span class="line"><span style="color:#24292e;">  .forRoutes(CatsController);</span></span></code></pre></div><p>如果你的中间件不需要依赖其它东西时，可以尽可能使用函数式中间件，较为简单</p><h3 id="_4-全局中间件" tabindex="-1">4. 全局中间件 <a class="header-anchor" href="#_4-全局中间件" aria-label="Permalink to &quot;4. 全局中间件&quot;">​</a></h3><p>在main.ts中直接使用app.use(中间件)</p><p>如经常添加的解决跨域的中间件(下面还自定义了logger日志系统，后面抽空再单独出一篇关于日志的)</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">async function bootstrap() {</span></span>
...
<span class="line"><span style="color:#24292e;">}</span></span>
<span class="line"><span style="color:#24292e;">bootstrap();</span></span></code></pre></div><h2 id="五、exception-filters" tabindex="-1">五、Exception filters <a class="header-anchor" href="#五、exception-filters" aria-label="Permalink to &quot;五、Exception filters&quot;">​</a></h2><p>Nest comes with a built-in <strong>exceptions layer</strong> which is responsible for processing all unhandled exceptions across an application. When an exception is not handled by your application code, it is caught by this layer, which then automatically sends an appropriate user-friendly response.</p><p>nest内置了一个异常处理层，如果我们没有手动处理异常，所有的异常都会进到这里，系统将给出响应的提示信息。</p><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/5a6de167abec43d7bb8c1be759105d64~tplv-k3u1fbpfcp-zoom-1.image" alt=""></p><p>如果没有手动做处理，发生异常时，response返回给前端的信息将是如下形式：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">{</span></span>
...
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><h3 id="_1-抛出标准异常" tabindex="-1">1. 抛出标准异常 <a class="header-anchor" href="#_1-抛出标准异常" aria-label="Permalink to &quot;1. 抛出标准异常&quot;">​</a></h3><p>nest内置了HttpException，可以直接抛出该异常</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">@Get()</span></span>
...
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><p>客户端请求的得到的结果如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">{</span></span>
...
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><p>请求返回值将变成：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">{</span></span>
<span class="line"><span style="color:#e1e4e8;">  status: HttpStatus.EXPECTATION_FAILED,</span></span>
<span class="line"><span style="color:#e1e4e8;">  error: &#39;this is a error msg&#39;,</span></span>
<span class="line"><span style="color:#e1e4e8;">  custom: &#39;this is a custom res&#39;,</span></span>
<span class="line"><span style="color:#e1e4e8;">},</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">{</span></span>
...
<span class="line"><span style="color:#24292e;">  error: &#39;this is a error msg&#39;,</span></span>
<span class="line"><span style="color:#24292e;">  custom: &#39;this is a custom res&#39;,</span></span>
<span class="line"><span style="color:#24292e;">},</span></span></code></pre></div><h3 id="_2-自定义异常" tabindex="-1">2. 自定义异常 <a class="header-anchor" href="#_2-自定义异常" aria-label="Permalink to &quot;2. 自定义异常&quot;">​</a></h3><p>我们可以创建一个类继承HttpException，在里面进行一些自定义配置，然后使用的时候直接throw xxxException</p><p>官网给我们内置了很多HttpException的子类，可以直接抛出。详见官网<a href="https://docs.nestjs.com/exception-filters" target="_blank" rel="noreferrer">https://docs.nestjs.com/exception-filters</a></p><p>如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">new BadRequestException(&#39;Something bad happened&#39;, { cause: new Error(), description: &#39;Some error description&#39; })</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">new BadRequestException(&#39;Something bad happened&#39;, { cause: new Error(), description: &#39;Some error description&#39; })</span></span></code></pre></div><p>返回结果如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">{</span></span>
...
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><p><strong>这里再提示一下：如果response参数只是一个字符串，那返回体将会把status作为statusCode属性的值，会把options里的description作为error属性的值，如果response参数是一个对象，那返回体就只有这个对象里的属性</strong></p><h3 id="_3-异常过滤器exception-filters" tabindex="-1">3. 异常过滤器Exception filters <a class="header-anchor" href="#_3-异常过滤器exception-filters" aria-label="Permalink to &quot;3. 异常过滤器Exception filters&quot;">​</a></h3><p>如果想要更加个性化的定制Exception返回数据格式，可以使用Exception filters，下面是我自定义的HttpExceptionFilter，它需要实现ExceptionFilter接口，实现里面catch方法，并使用@Catch()装饰器进行修饰，它接收一个或多个参数，表明要捕获哪些异常.</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">import {</span></span>
...
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><h3 id="_4-使用filters" tabindex="-1">4. 使用filters <a class="header-anchor" href="#_4-使用filters" aria-label="Permalink to &quot;4. 使用filters&quot;">​</a></h3><h4 id="_1方法作用域" tabindex="-1">①方法作用域 <a class="header-anchor" href="#_1方法作用域" aria-label="Permalink to &quot;①方法作用域&quot;">​</a></h4><p>可以绑定到具体的方法上，使用@UseFilters(new HttpExceptionFilter())装饰器，可以传多个filter，<strong>亦可以使用类名作为参数，创建实例的事就交给nest框架帮我们处理，尽可能使用类作为参数，可以减小内存开支，因为全局公用一个实例instance</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">@Post()</span></span>
...
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><h4 id="_2controller作用域" tabindex="-1">②Controller作用域 <a class="header-anchor" href="#_2controller作用域" aria-label="Permalink to &quot;②Controller作用域&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">@UseFilters(new HttpExceptionFilter())</span></span>
...
<span class="line"><span style="color:#24292e;">export class CatsController {}</span></span></code></pre></div><h4 id="_3全局作用域" tabindex="-1">③全局作用域 <a class="header-anchor" href="#_3全局作用域" aria-label="Permalink to &quot;③全局作用域&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">async function bootstrap() {</span></span>
...
<span class="line"><span style="color:#24292e;">  ],</span></span>
<span class="line"><span style="color:#24292e;">})</span></span>
<span class="line"><span style="color:#24292e;">export class AppModule {}</span></span></code></pre></div><p>这跟后面要将的全局Guard类似</p><h3 id="_5-捕获所有异常" tabindex="-1">5. 捕获所有异常 <a class="header-anchor" href="#_5-捕获所有异常" aria-label="Permalink to &quot;5. 捕获所有异常&quot;">​</a></h3><p>@Catch()的参数列表为空时修饰的filter就是一个能捕获所有异常的filter，贴出官网的示例代码</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">import {</span></span>
<span class="line"><span style="color:#e1e4e8;">  ExceptionFilter,</span></span>
<span class="line"><span style="color:#e1e4e8;">  Catch,</span></span>
<span class="line"><span style="color:#e1e4e8;">  ArgumentsHost,</span></span>
<span class="line"><span style="color:#e1e4e8;">  HttpException,</span></span>
...
<span class="line"><span style="color:#24292e;">  }</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><p>使用的时候，可以给构造器传入一个httpAdapter参数</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">async function bootstrap() {</span></span>
<span class="line"><span style="color:#e1e4e8;">  const app = await NestFactory.create(AppModule);</span></span>
<span class="line"><span style="color:#e1e4e8;"></span></span>
...
<span class="line"><span style="color:#24292e;">  await app.listen(3000);</span></span>
<span class="line"><span style="color:#24292e;">}</span></span>
<span class="line"><span style="color:#24292e;">bootstrap();</span></span></code></pre></div><h3 id="_6-继承baseexceptionfilter" tabindex="-1">6.继承BaseExceptionFilter <a class="header-anchor" href="#_6-继承baseexceptionfilter" aria-label="Permalink to &quot;6.继承BaseExceptionFilter&quot;">​</a></h3><p>用于修改默认的内置全局异常，对于这种异常类，如果作用于方法或者Controller，则UseFilters()的参数只能使用类，让nest帮我们做剩下的事</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">import { Catch, ArgumentsHost } from &#39;@nestjs/common&#39;;</span></span>
...
<span class="line"><span style="color:#24292e;">  return req.user;</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><p>到请求为/hello/123时正常返回</p><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7e9af5dd2dd14461b9e0724958b0cb60~tplv-k3u1fbpfcp-zoom-1.image" alt=""></p><p>当请求为/hello/123a时，转换出错，抛出异常</p><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/bdc65119443b4ea4895ac3073477b878~tplv-k3u1fbpfcp-zoom-1.image" alt=""></p><ul><li>使用自定义的实例</li></ul><p>如下自定义statuscode</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">getHello(</span></span>
...
<span class="line"><span style="color:#24292e;">    console.log(typeof id);</span></span>
<span class="line"><span style="color:#24292e;">    return req.user;</span></span>
<span class="line"><span style="color:#24292e;">  }</span></span></code></pre></div><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/01df501b269d44e1b92f2501e686938e~tplv-k3u1fbpfcp-zoom-1.image" alt=""></p><h3 id="_2-自定义pipes-validation为例" tabindex="-1">2. 自定义Pipes(validation为例) <a class="header-anchor" href="#_2-自定义pipes-validation为例" aria-label="Permalink to &quot;2. 自定义Pipes(validation为例)&quot;">​</a></h3><p>不论是transformation还是validation都需要使用@Injectable()装饰器，并实现PipeTransform接口，基本实现如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">import { ArgumentMetadata, Injectable, PipeTransform } from &#39;@nestjs/common&#39;;</span></span>
<span class="line"><span style="color:#e1e4e8;"></span></span>
<span class="line"><span style="color:#e1e4e8;">@Injectable()</span></span>
...
<span class="line"><span style="color:#24292e;">  }</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><p>其中value就是被CustomValidationPipe修饰的参数，metadata是该参数的meta属性，它类型如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">export interface ArgumentMetadata {</span></span>
...
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><h5 id="使用class-validator" tabindex="-1">使用class validator <a class="header-anchor" href="#使用class-validator" aria-label="Permalink to &quot;使用class validator&quot;">​</a></h5><p>官网上讲了好几种不同实现，我们主要看class validator，依托于class-validator和class-transformer，先安装依赖</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">$ npm i --save class-validator class-transformer</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">$ npm i --save class-validator class-transformer</span></span></code></pre></div><p>对于我们新建用户来说，要校验创建用户的信息，对创建用户的Dto类使用class-validator的各种验证装饰器</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">import { IsOptional, IsString } from &#39;class-validator&#39;;</span></span>
<span class="line"><span style="color:#e1e4e8;"></span></span>
...
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><p>编写validation-pipes类</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">import {</span></span>
...
<span class="line"><span style="color:#24292e;">  }</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><p>使用：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">@Post()</span></span>
...
<span class="line"><span style="color:#24292e;">  }</span></span></code></pre></div><p>验证如下，将password写成了number而不是string</p><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/dcded6dddd6c4ce1a01c636dd0851bfa~tplv-k3u1fbpfcp-zoom-1.image" alt=""></p><h3 id="_3-全局作用域下的pipes" tabindex="-1">3. 全局作用域下的pipes <a class="header-anchor" href="#_3-全局作用域下的pipes" aria-label="Permalink to &quot;3. 全局作用域下的pipes&quot;">​</a></h3><p>依然是两种形式</p><ul><li>使用useGlobalPipes</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">// 全局validationPipes</span></span>
...
<span class="line"><span style="color:#24292e;">  app.useGlobalPipes(new CustomValidationPipe());</span></span></code></pre></div><ul><li>使用依赖注入，在任意一个模块注入都可以</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">@Module({</span></span>
<span class="line"><span style="color:#e1e4e8;">  providers: [</span></span>
<span class="line"><span style="color:#e1e4e8;">    {</span></span>
...
<span class="line"><span style="color:#24292e;">  ],</span></span>
<span class="line"><span style="color:#24292e;">})</span></span>
<span class="line"><span style="color:#24292e;">export class AppModule {}</span></span></code></pre></div><h3 id="_4-内置validationpipe" tabindex="-1">4. 内置validationPipe <a class="header-anchor" href="#_4-内置validationpipe" aria-label="Permalink to &quot;4. 内置validationPipe&quot;">​</a></h3><p>当然讲了这么多，只是说明了原理，其实我们大可不必自己写，直接使用内置的就行，而且提供了丰富的配置自定义功能，具体详情可移步官网：<a href="https://docs.nestjs.com/techniques/validation" target="_blank" rel="noreferrer">https://docs.nestjs.com/techniques/validation</a></p><p>基本使用：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">import { ValidationPipe } from &#39;@nestjs/common&#39;;</span></span>
<span class="line"><span style="color:#e1e4e8;"></span></span>
...
<span class="line"><span style="color:#24292e;">  }),</span></span>
<span class="line"><span style="color:#24292e;">);</span></span></code></pre></div><h3 id="_5-transformation-pipes自定义使用场景" tabindex="-1">5. transformation-pipes自定义使用场景 <a class="header-anchor" href="#_5-transformation-pipes自定义使用场景" aria-label="Permalink to &quot;5. transformation-pipes自定义使用场景&quot;">​</a></h3><p>我们也可以自定义transformation pipes，这个很简单，就是在transform方法内返回不同的结果就行了，它会覆盖之前的value，这是对前端传值的干预，有时候也会很有用</p><ul><li>比如将数据类型进行转换</li><li>对需要的数据如果某个属性不存在那就给它一个默认值，比如做查询操作的时候，有些查询参数没传那就使用默认值</li></ul><p>官网示例：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">@Injectable()</span></span>
...
<span class="line"><span style="color:#24292e;">  }</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><p>注意这里PipeTransform&lt;T, R&gt;泛型的使用，T表示输入的类型，R表示返回的类型</p><p>使用和之前讲的一样：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">@Get(&#39;:id&#39;)</span></span>
...
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><h3 id="_6-实现id转user实体的transformation-pipe" tabindex="-1">6. 实现id转user实体的transformation pipe <a class="header-anchor" href="#_6-实现id转user实体的transformation-pipe" aria-label="Permalink to &quot;6. 实现id转user实体的transformation pipe&quot;">​</a></h3><p>这里实现一下官网上的另外一个留给读者的例子，就是前端传入的是一个userId，我们需要在transformation pipe中根据这个id来返回一个用户对象，也就是将id转换为用户</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">import { ArgumentMetadata, Injectable, PipeTransform } from &#39;@nestjs/common&#39;;</span></span>
...
<span class="line"><span style="color:#24292e;">    }</span></span>
<span class="line"><span style="color:#24292e;">  }</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><p>使用</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">@Get(&#39;users/:id&#39;)</span></span>
...
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><p>测试</p><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/695b8739bce240d8b338c6a4029b7fff~tplv-k3u1fbpfcp-zoom-1.image" alt=""></p><h3 id="_7-pipe提供默认值" tabindex="-1">7. pipe提供默认值 <a class="header-anchor" href="#_7-pipe提供默认值" aria-label="Permalink to &quot;7. pipe提供默认值&quot;">​</a></h3><p>主要用在前端传过来的数据是null或者undefined，如果我们不做处理可能会抛出异常，所以我们可以在他们转换前再加一层提供默认值的管道，较为简单，直接引用官方的示例</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">@Get()</span></span>
<span class="line"><span style="color:#e1e4e8;">async findAll(</span></span>
...
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><h2 id="七、guards" tabindex="-1">七、Guards <a class="header-anchor" href="#七、guards" aria-label="Permalink to &quot;七、Guards&quot;">​</a></h2><p>A guard is a class annotated with the @Injectable() decorator, which implements the CanActivate interface.</p><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/bd51a71392a74fc08dab8ae87b427011~tplv-k3u1fbpfcp-zoom-1.image" alt=""></p><p>字面理解就是守卫，它最突出的作用就是用来做鉴权，就是来决定一个请求是否被处理及怎么处理，这依赖于一定的条件，比如权限、角色等等，它和用户权限挂钩。可能有的同志回想用中间件来处理，中间件对一般的要求还可以做到，但是对一些复杂需求，比如不同权限接下去要进行的操作是不一样的，我们使用中间件仅仅靠一个next函数是没法精确控制下一步往哪里走的。</p><p>Guards的执行顺序在所有的中间件之后，但是在任何的interceptor和pipe之前</p><h3 id="_1-基本示例代码" tabindex="-1">1. 基本示例代码 <a class="header-anchor" href="#_1-基本示例代码" aria-label="Permalink to &quot;1. 基本示例代码&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">import { Injectable, CanActivate, ExecutionContext } from &#39;@nestjs/common&#39;;</span></span>
...
<span class="line"><span style="color:#24292e;">  }</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><ul><li>使用@Injectable装饰器，实现CanActivate接口</li><li>canActivate方法，重点关注context执行上下文对象，比较强大。</li><li>方法返回true继续执行，返回false拒绝该次请求</li></ul><h3 id="_2-execution-context" tabindex="-1">2. Execution context <a class="header-anchor" href="#_2-execution-context" aria-label="Permalink to &quot;2. Execution context&quot;">​</a></h3><p>继承自ArgumentHost，详情见官网：<a href="https://docs.nestjs.com/fundamentals/execution-context" target="_blank" rel="noreferrer">https://docs.nestjs.com/fundamentals/execution-context</a></p><p>Nest提供了很多实用的工具类来帮我们更轻松的编写应用，Execution context就是其一，后面单独开一篇来将ArgumentsHost和ExecutionContext。</p><h3 id="_3-基于role的权限认证" tabindex="-1">3.基于Role的权限认证 <a class="header-anchor" href="#_3-基于role的权限认证" aria-label="Permalink to &quot;3.基于Role的权限认证&quot;">​</a></h3><p>这里主要讲一个东西就是@SetMetadata的使用，这是用来添加元数据的，我们想实现的功能大概如下：</p><p>在Controller或method-handler上加一个类似Roles(&#39;admin&#39;)装饰器，让只具有admin角色的用户能够访问和调用，如下表示只有admin权限的用户才有资格访问：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">@Post()</span></span>
...
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><p>如何做到这一点呢?先来个思路分析</p><p>我们在canActivate方法中需要做一下几个事情：</p><ul><li>一是获取当前登录用户的role角色信息，这个可以通过contex拿到request，一般我们会在认证那一步就将user信息附加到request上，这样我们直接通过request.user即可拿到user信息，详见我的系列第一篇，主要就是将用户认证的<a href="https://juejin.cn/post/7171424088827625479" target="_blank" rel="noreferrer">https://juejin.cn/post/7171424088827625479</a></li><li>二是要获取到@Roles()装饰器的参数信息，即标示了哪些用户角色可以访问，这就需要用到两个东西：①Roles装饰器需要自定义，通过对@SetMetadata进行一层包裹，对所装饰的Controller或method添加元数据；②Nest框架给我们提供的反射类，通过反射类拿到装饰器内的参数</li></ul><p>具体做法如下：</p><p>自定义@Roles装饰器</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">import { SetMetadata } from &#39;@nestjs/common&#39;;</span></span>
<span class="line"><span style="color:#e1e4e8;"></span></span>
...
<span class="line"><span style="color:#24292e;"></span></span>
<span class="line"><span style="color:#24292e;">export const Roles = (...roles: string[]) =&gt; SetMetadata(&#39;roles&#39;, roles);</span></span></code></pre></div><p>构造一个Guard</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">import { Injectable, CanActivate, ExecutionContext } from &#39;@nestjs/common&#39;;</span></span>
...
<span class="line"><span style="color:#24292e;">  }</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><p>对于鉴权后的一些操作，可以根据自己的业务逻辑需要进行定制，至此，Guard基本也讲完了。</p><h2 id="八、interceptors" tabindex="-1">八、Interceptors <a class="header-anchor" href="#八、interceptors" aria-label="Permalink to &quot;八、Interceptors&quot;">​</a></h2><p>An interceptor is a class annotated with the @Injectable() decorator and implements the NestInterceptor interface.</p><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c6e1e9ce0fad4132abc21760b1bd3cef~tplv-k3u1fbpfcp-zoom-1.image" alt=""></p><p>拦截器！面向切面编程，具有以下能力：</p><ul><li>在某个方法执行前后增加额外逻辑</li><li>修改一个方法返回的结果</li><li>修改一个方法抛出的错误</li><li>扩展一个方法的功能</li><li>根据某些特别的条件，重写一个方法，比如为了缓存目的</li></ul><h3 id="_1-实现接口及方法参数解析" tabindex="-1">1. 实现接口及方法参数解析 <a class="header-anchor" href="#_1-实现接口及方法参数解析" aria-label="Permalink to &quot;1. 实现接口及方法参数解析&quot;">​</a></h3><p>每一个拦截器都需要实现一个NestInterceptor接口，实现里面的intercept方法，接口定义如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">/**</span></span>
...
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><p>可以看出，该接口提供了访问Response流的能力，handle()函数的返回值就是response流，类型是一个<code>Observable&lt;T&gt;</code>类型（Observable这是rxjs的内容了，后面有机会单独开一个rxjs的系列，这也是一个非常强大的库，在帮我们处理异步事件的时候用处很大，有兴趣的可移步官网提前学习：<a href="https://rxjs.dev/guide/overview" target="_blank" rel="noreferrer">https://rxjs.dev/guide/overview</a>），你可以在合适的位置使用它来调用你的route handler，如果在intercept()方法的实现中没有调用过handle()方法，那么route handler将不会被执行。</p><p><strong>调用handle()方法前的处理逻辑相当与在route handler之前添加的逻辑，在handle()方法执行后的逻辑相当于在route handler之后添加的逻辑，实现了对route handler的拦截。</strong></p><h3 id="_2-简单示例" tabindex="-1">2. 简单示例 <a class="header-anchor" href="#_2-简单示例" aria-label="Permalink to &quot;2. 简单示例&quot;">​</a></h3><p>我们做一个日志相关的拦截器，实现的目的是route handler处理前记录时间并打印一段提示信息，处理之后打印另一段提示信息并记录route handler的执行时长</p><h4 id="构建拦截器" tabindex="-1">构建拦截器 <a class="header-anchor" href="#构建拦截器" aria-label="Permalink to &quot;构建拦截器&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">@Injectable()</span></span>
...
<span class="line"><span style="color:#24292e;">      );</span></span>
<span class="line"><span style="color:#24292e;">  }</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><h4 id="绑定拦截器" tabindex="-1">绑定拦截器 <a class="header-anchor" href="#绑定拦截器" aria-label="Permalink to &quot;绑定拦截器&quot;">​</a></h4><p>和pipes和guards一样，可以绑定到Controller层、method层以及全局作用域，下面绑定到method层面，使用@UseInterceptors拦截器</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">@UseInterceptors(LoggingInterceptor)</span></span>
...
<span class="line"><span style="color:#24292e;">  }</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><p>测试结果</p><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0fd4e37dbe8d46f392991b68006c7279~tplv-k3u1fbpfcp-zoom-1.image" alt=""></p><p><strong>如果要绑定全局作用域，可以使用如下两种方式</strong></p><ul><li>useGlobalInterceptors</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">app.useGlobalInterceptors(new LoggingInterceptor());</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">app.useGlobalInterceptors(new LoggingInterceptor());</span></span></code></pre></div><ul><li>依赖注入方式</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">@Module({</span></span>
<span class="line"><span style="color:#e1e4e8;">  providers: [</span></span>
<span class="line"><span style="color:#e1e4e8;">    {</span></span>
...
<span class="line"><span style="color:#24292e;">  ],</span></span>
<span class="line"><span style="color:#24292e;">})</span></span>
<span class="line"><span style="color:#24292e;">export class AppModule {}</span></span></code></pre></div><p><strong>其实我们可以总结一下关于绑定的方式，我将在核心概念的最后一篇进行一个梳理，对所有涉及到的使用方式做一个总结，其实我个人比较推荐统一都使用注入的方式。</strong></p><h3 id="_3-response结果转换" tabindex="-1">3. response结果转换 <a class="header-anchor" href="#_3-response结果转换" aria-label="Permalink to &quot;3. response结果转换&quot;">​</a></h3><p>由上面可知，我们通过handle()方法拿到了响应流的Observable对象，进而可以对结果进行各种修改转换操作。但是有一点要注意：当route handler中接收 @Res装饰器装饰的参数时不能使用。经过我的测试，发现这么做会阻塞整个请求</p><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/aa868fe9ed064b44bf615c4775e3db01~tplv-k3u1fbpfcp-zoom-1.image" alt=""></p><p>做数据转换的拦截器很简单，只需要在pipe管道中进行map操作就行，可以参考官方的示例：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">export interface Response&lt;T&gt; {</span></span>
...
<span class="line"><span style="color:#24292e;">  }</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><p>提示一下，intercept方法依然可以是同步也可以是异步</p><p>map操作可以做任意转换，如：</p><ul><li>将值转换成一个对象</li><li>将null值转换默认的空字符串</li><li>对Exception的转换</li></ul><p>具体的就不做演示了，这个大家应该很熟悉，和js中的map高阶函数一个道理</p><h3 id="_4-结果覆盖" tabindex="-1">4. 结果覆盖 <a class="header-anchor" href="#_4-结果覆盖" aria-label="Permalink to &quot;4. 结果覆盖&quot;">​</a></h3><p>说白了就是某些情况我们不在调用handle处理，为什么呢？可能有时候是多余的，比如结果已经在缓存中有，我们直接在缓存中提取就好了，不用做重复的处理，这可以大大提升性能和响应速度。伪代码逻辑大概如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">const isCached = true;</span></span>
...
<span class="line"><span style="color:#24292e;">}</span></span>
<span class="line"><span style="color:#24292e;">return next.handle();</span></span></code></pre></div><h3 id="_5-其它操作" tabindex="-1">5. 其它操作 <a class="header-anchor" href="#_5-其它操作" aria-label="Permalink to &quot;5. 其它操作&quot;">​</a></h3><p>我们可以充分利用rxjs的强大处理能力，实现更丰富的功能，官方举了一个例子，就是请求处理超时抛出错误的例子，可以参考一下代码，只截取了一部分，pipe中的操作是，超时5s就抛出异常取消该次请求</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">return next.handle().pipe(</span></span>
...
<span class="line"><span style="color:#24292e;">      }),</span></span>
<span class="line"><span style="color:#24292e;">    );</span></span></code></pre></div><h2 id="九、custom-decorators" tabindex="-1">九、Custom decorators <a class="header-anchor" href="#九、custom-decorators" aria-label="Permalink to &quot;九、Custom decorators&quot;">​</a></h2><p>装饰器这个概念对JavaScript来说感觉是一次小小的革新，非常好用，其实所谓的装饰器就是一个函数，@的写法是一个语法糖，它可以修饰类、方法、属性及参数，看一下es源码</p><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/61f4971c974f40c49f7e9c82c664d1af~tplv-k3u1fbpfcp-zoom-1.image" alt=""></p><p>nest为我们内置了很多装饰器，各个层面的都有，我们定义类的时候用的最多的就是@Injectable了吧，哈哈，下面我们来自定义一些装饰器，非常好用！</p><h3 id="_1-参数级别装饰器" tabindex="-1">1. 参数级别装饰器 <a class="header-anchor" href="#_1-参数级别装饰器" aria-label="Permalink to &quot;1. 参数级别装饰器&quot;">​</a></h3><p>我们在一个系统登录认证后，token里的user信息都会被附加到request中，我们可以做一个参数装饰器直接获取当前请求携带的user，具体做法如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">import { createParamDecorator, ExecutionContext } from &#39;@nestjs/common&#39;;</span></span>
...
<span class="line"><span style="color:#24292e;">  },</span></span>
<span class="line"><span style="color:#24292e;">);</span></span></code></pre></div><p>使用</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">@Get(&#39;userDec/test&#39;)</span></span>
...
<span class="line"><span style="color:#24292e;">  }</span></span></code></pre></div><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0b4d6ea782f340ca93a64ed019fc5548~tplv-k3u1fbpfcp-zoom-1.image" alt=""></p><p>当然这个的前提是你request中得有user啊，这就涉及到认证相关的内容了，可以移步我的nestjs系列第一篇查看：<a href="https://juejin.cn/post/7171424088827625479" target="_blank" rel="noreferrer">https://juejin.cn/post/7171424088827625479</a></p><h3 id="_2-给装饰器传参" tabindex="-1">2. 给装饰器传参 <a class="header-anchor" href="#_2-给装饰器传参" aria-label="Permalink to &quot;2. 给装饰器传参&quot;">​</a></h3><p>给装饰器传参会放到factory方法的data域中，比如我们想给上面的User装饰器传一个属性名username直接获取用户的username，可以这么做：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">export const UserDecorator = createParamDecorator(</span></span>
...
<span class="line"><span style="color:#24292e;">  }</span></span></code></pre></div><h3 id="_3-结合pipes" tabindex="-1">3. 结合pipes <a class="header-anchor" href="#_3-结合pipes" aria-label="Permalink to &quot;3. 结合pipes&quot;">​</a></h3><p>可以对自定义的装饰器的参数进行校验，下面使用的是框架自带的ValidationPipe</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">@Get()</span></span>
...
<span class="line"><span style="color:#24292e;">) {</span></span>
<span class="line"><span style="color:#24292e;">  console.log(user);</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><h3 id="_4-装饰器组合封装" tabindex="-1">4. 装饰器组合封装 <a class="header-anchor" href="#_4-装饰器组合封装" aria-label="Permalink to &quot;4. 装饰器组合封装&quot;">​</a></h3><p>有时候，我们对一个东西加的装饰器很多，看着代码非常复杂，可以进行抽取重构，将一些经常使用作用可以聚合的放在一起，最后实现用一个装饰器实现对好几个装饰器的封装，如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">import { applyDecorators } from &#39;@nestjs/common&#39;;</span></span>
<span class="line"><span style="color:#e1e4e8;"></span></span>
...
<span class="line"><span style="color:#24292e;">  );</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><p>使用的时候只需要用一个就行</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">@Get(&#39;users&#39;)</span></span>
...
<span class="line"><span style="color:#24292e;">findAllUsers() {}</span></span></code></pre></div>`,314),o=[l];function t(c,r,i,d,y,u){return e(),n("div",null,o)}const m=s(p,[["render",t]]);export{g as __pageData,m as default};
